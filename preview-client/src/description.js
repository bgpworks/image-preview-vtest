...
const description = {
    turnPolicy: {
        ...
        description: "how to resolve ambiguities in path decomposition. Possible values are exported as constants: 'black', 'white', 'left', 'right', 'minority', 'majority'",
    },
    turdSize: {
        name: "turdSize",
        input: true,
    ...
    threshold: {
        ...
        options: "",
        input: true,
        description: "threshold below which color is considered black. Should be a number in range 0..255",
    },
    blackOnWhite: {
        name: "blackOnWhite",
        options: booleanValue,
    ...
    color: {
        ...
        options: "",
        input: true,
        description: "Fill color. Will be ignored when exporting as <symbol>. (default: COLOR_AUTO, which means black or white, depending on blackOnWhite property) , tyoe: string",
    },
    background: {
        name: "background",
        options: "",
        input: true,
        description: "Background color. Will be ignored when exporting as <symbol>.",
    },
    fillStrategy: {
        name: "fillStrategy",
